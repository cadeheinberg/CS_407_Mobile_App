...
public class TaskObject implements Comparable<TaskObject> {
    ...
    public TaskObject(Integer id, boolean checked, String username, Date startDate, Date endDate, String locationName, String locationAddress, String title, String description, String photoLink) {
        this.id = id;
